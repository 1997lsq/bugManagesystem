...
<form action="<%=request.getContextPath() %>/project/addBug.action" method="post">
  <table border="0" align="center" >
    ...
    <tr > <td class="auto-style3" colspan="2" align="center" style="font-family:'Microsoft Himalaya'"><b>添加BUG</b></td></tr>
    ...
    <tr  style="margin-top: 10px">
      <td  align="right" > <font size="2"  ><b>项目id：</b></font> </td>
      <td>
        <div class="input-group">
          <span class="input-group-addon"><font style="font-family: 'Segoe MDL2 Assets'">&#xE1A6</font></span>
          <input type="text" name="proid" class="form-control" placeholder="proid" value="<%=request.getParameter("proid")%>" readonly>
        </div>
      </td>
    </tr>

    <tr >
      <td align="right" > <div style="margin-top: 25px"> <font size = 2   ><b >创建人：</b></font> </div></td>
      <td >
    ...
    <tr>
      <td align="right"><div style="margin-top: 25px"><font size = 2  ><b>创建日期：</b></font> </div></td>
      <td >
        <div class="input-group" style="margin-top: 25px">
          <span class="input-group-addon"><font style="font-family: 'Segoe MDL2 Assets'">&#xE170</font></span>
          <input type="text" class="form-control" name="createDate" placeholder="create date">
        </div>
      </td>
    </tr>

    <tr>
      <td align="right"><dir  style="margin-top: 25px"><font size = 2 ><b>处理日期：</b></font> </dir></td>

      <td >
        <div class="input-group" style="margin-top: 25px">
          <span class="input-group-addon"><font style="font-family: 'Segoe MDL2 Assets'">&#xE168</font></span>
          <input type="text" class="form-control" name="createDate" placeholder="process date">
        </div>
      </td>
    </tr>

    <tr>
      <td align="right"><dir  style="margin-top: 25px"><font size = 2 ><b>Bug内容：</b></font> </dir></td>
