...
<form action="<%=request.getContextPath() %>/project/updateProject.action" method="post">
  <table border="0" align="center" >
    <tr><td class="auto-style6"></td></tr>
    <tr > <td class="auto-style3" colspan="2" align="center" style="font-family:'Microsoft Himalaya'"><b>更新项目</b></td></tr>
    <tr>
      <td colspan="2" >
    ...
    <tr  style="margin-top: 10px">
      ...
      <td>
        <div class="input-group">
          ...
          <input type="text" name="pro_id" class="form-control" readonly placeholder="pro_id" value="<%=request.getParameter("pro_id")%>">
        </div>
      </td>
    </tr>
    ...
    <tr>
      <td align="right"><div style="margin-top: 25px"><font size = 2  ><b>项目名：</b></font> </div></td>
      <td >
        <div class="input-group" style="margin-top: 25px">
          <span class="input-group-addon"><font style="font-family: 'Segoe MDL2 Assets'">&#xE0E7</font></span>
          <input type="text" class="form-control" name="name" placeholder="name" value="<%=request.getParameter("name")%>">
        </div>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td >
        <div class="input-group" style="margin-top: 25px">
          <span class="input-group-addon"><font style="font-family: 'Segoe MDL2 Assets'">&#xE0E7</font></span>
          <input type="text" class="form-control" name="wordkey" placeholder="wordkey" value="<%=request.getParameter("wordkey")%>">
        </div>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td >
        <div class="input-group" style="margin-top: 25px">
          ...
          <input type="text" class="form-control" name="description" placeholder="description" value="<%=request.getParameter("description")%>">
        </div>
      </td>
    </tr>
    ...
    <td >
      <div class="input-group" style="margin-top: 25px">
        ...
        <input type="text" class="form-control" name="date" placeholder="date" value="<%=request.getParameter("date")%>">
      </div>
    </td>
  </tr>
