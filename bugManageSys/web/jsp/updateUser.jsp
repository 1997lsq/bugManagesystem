...
<head>
  ...
  <script type="text/javascript">
      ...
      jsSelectItemByValue(document.getElementById("role_select"), request.getParameter("role_id");
  </script>
  <style type="text/css">
    .auto-style6 {
      height: 120px;
...
<form action="<%=request.getContextPath() %>/user/updateUser.action" method="post">
  <table border="0" align="center" >
    ...
    <tr > <td class="auto-style3" colspan="2" align="center" style="font-family:'Microsoft Himalaya'"><b>更新用户</b></td></tr>
   ...
   <!-- <tr><td colspan="2"><hr style="height:5px;border-top:5px solid #555555; width: 395px; border-left-style: none; border-left-color: inherit; border-left-width: medium; border-right-style: none; border-right-color: inherit; border-right-width: medium; border-bottom-style: none; border-bottom-color: inherit; border-bottom-width: medium;" /></td></tr>!-->
    ...
    <tr  style="margin-top: 10px">
      ...
      <td>
        <div class="input-group">
          ...
          <input type="text" name="user_id" class="form-control" placeholder="user_id" readonly value="<%=request.getParameter("user_id")%>">
        </div>
      </td>
    </tr>

    <tr  style="margin-top: 10px">
      <td  align="right" style="margin-top: 25px"> <font size="2"  ><b>用户名：</b></font> </td>
      <td>
        <div class="input-group" style="margin-top: 25px">
          <span class="input-group-addon"><font style="font-family: 'Segoe MDL2 Assets'">&#xE1A6</font></span>
          <input type="text" name="userName" class="form-control" placeholder="username" value="<%=request.getParameter("userName")%>">
        </div>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td >
        <div class="input-group" style="margin-top: 25px">
          ...
          <input type="text" class="form-control" name="realName" placeholder="realname" value="<%=request.getParameter("realName")%>">
        </div>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td >
        <div class="input-group" style="margin-top: 25px">
          ...
          <input type="text" class="form-control" name="email" placeholder="e-mail" value="<%=request.getParameter("email")%>">
        </div>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td align="left">
        <div style="margin-top: 25px">  <select  name="user_role.role_id" id="role_select" class="selectpicker show-tick form-control"  data-live-search="false">>
